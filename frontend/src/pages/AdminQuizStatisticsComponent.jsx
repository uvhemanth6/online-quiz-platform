...
const AdminQuizStatisticsComponent = ({ quizzes, allResults }) => {
    ...
    return (
        <div className="bg-gray-800/70 p-6 rounded-xl shadow-lg border border-gray-700 mt-6">
            <h3 className="text-2xl font-bold text-white mb-4">Overall Quiz Performance</h3>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mt-8 mb-4">
                ...
                <input
                    ...
                    className="w-full sm:w-1/2 p-3 rounded-lg bg-gray-700 text-white border border-gray-600 focus:ring-cyan-500 focus:border-transparent transition-all duration-200"
                    value={searchTerm}
